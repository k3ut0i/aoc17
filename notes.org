...
#+begin_src perl :exports both :var infile='inputs/day7'
  use lib 'lib';
  use Day7;
  open my $fh, '<', $infile or die "File error $infile: $!";
  my @lines;
...
| svugo |
|     5 |
TODO: My current implementation is very buggy. The result of the above script keeps changing. Sometimes the node is different and other times the rank.
** Agda Version
*** Day 1
